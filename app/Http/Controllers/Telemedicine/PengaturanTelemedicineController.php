...
class PengaturanTelemedicineController extends Controller
{
    ...
    public function form(Request $request)
    {
        ...
        return view('admin.telemedicine.pengaturan.main', $data);
    }

    public function get(Request $request)
    {
        $data = PengaturanTelemedicine::where('id_pengaturan_telemedicine', 1)->first();
        if ($data) {
    ...
    public function store(Request $request)
    {
        ...
        $data = new PengaturanTelemedicine;
        if ($request->senin == "on") {
