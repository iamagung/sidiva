...
class PaketTelemedicineController extends Controller
{
    function __construct()
	{
		$this->title = 'Paket Telemedicine';
	}

    public function main(Request $request)
    {
        if(request()->ajax()){
            $data = PaketTelemedicine::orderBy('id_paket_telemedicine','DESC')->get();
        ...
        return view('admin.telemedicine.paket.main', $data);
    }
    ...
    public function form(Request $request)
    {
        ...
        $content = view('admin.telemedicine.paket.form', $data)->render();
