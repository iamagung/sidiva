...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="pe-3">
            <span style="font-weight: bold;">Syarat dan Ketentuan Telemedicine<span>
        </div>
    </div>
    ...
    <div class="card main-layer">
        ...
        <div class="card-body">
            <form id="commentForm">
                <div class="row mb-3">
                    <input type="hidden" name="id" id="id" value="{{ !empty($syarat) ? $syarat->id_syarat_aturan_telemedicine : ''}}">
                    <div class="col-md-12">
                        <label></label><br>
...
<script type="text/javascript">
    ...
    $('#simpan').click(function (e) {
        ...
        if(isi==''){
            ...
            $.ajax({
                url : "{{route('saveSyaratTelemedicine')}}",
                type: "POST",
                data: data,
                contentType : false,
                processData: false
