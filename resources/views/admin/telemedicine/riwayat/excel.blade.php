...
<table id="excelDebet" style="height:auto;">
	<thead>
		...
		<tr>
			<td colspan="10"><p style="text-align: center;">Status Pasien : {{ $status }}</p></td>
		</tr>
		<tr>
			...
			<th><p style="font-weight:bold;text-align:center">Keluhan</p></th>
			<th><p style="font-weight:bold;text-align:center">Poli Layanan</p></th>
            <th><p style="font-weight:bold;text-align:center">Tanggal Kunjungan</p></th>
			<th><p style="font-weight:bold;text-align:center">Jam</p></th>
			<th><p style="font-weight:bold;text-align:center">Nama Dokter</p></th>
			<th><p style="font-weight:bold;text-align:center">Nama Perawat</p></th>
	...
	<tbody id='panelHasil'>
		...
		<tr>
			...
			<td><p style="padding: 5px; vertical-align: middle;" align="center" valign="middle">{{!empty($item->keluhan) ? $item->keluhan : '-'}}</p></td>
			<td><p style="padding: 5px; vertical-align: middle;" align="center" valign="middle">{{$item->nama_poli}}</p></td>
            <td><p style="padding: 5px; vertical-align: middle;" align="center" valign="middle">{{$item->tanggal_kunjungan}}</p></td>
			<td><p style="padding: 5px; vertical-align: middle;" align="center" valign="middle">{{$item->jadwal_dokter}}</p></td>
			<td><p style="padding: 5px; vertical-align: middle;" align="center" valign="middle">{{$item->nama_dokter}}</p></td>
			<td><p style="padding: 5px; vertical-align: middle;" align="center" valign="middle">{{$item->nama_perawat ? $item->nama_perawat : '-'}}</p></td>
			...
			<td><p style="padding: 5px; vertical-align: middle;" align="center" valign="middle">{{$item->status_pasien}}</p></td>
		</tr>
		@php
		$no++;
		@endphp
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#excelDebet').table2excel({
			exclude: ".noExl",
			name: "Permintaan Telemedicine",
			filename: "Permintaan Telemedicine "+output+".xls",
			fileext: ".xls",
			exclude_img: false,
			exclude_links: false,
			exclude_inputs: true,
