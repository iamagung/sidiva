...
<script type="text/javascript">
    ...
    function loadTable(){
        var table = $('#datatabel').DataTable({
            ...
            ajax: {
                url: "{{route('mainLayananTelemedicine')}}",
            },
            columns: [
    ...
    function formAdd(id='') {
        $('.main-layer').hide();
        $.post("{{route('formLayananTelemedicine')}}", {id:id})
        .done(function(data){
    ...
    function hapus(id) {
        Swal.fire({
            ...
            text: "Data Layanan Homecare Akan Dihapus Permanen",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                $.post("{{route('deleteLayananTelemedicine')}}",{id:id})
                .done((data) => {
                    if(data.status == "success"){
