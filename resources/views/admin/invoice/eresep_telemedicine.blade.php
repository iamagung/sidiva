...
<head>
    <meta charset="utf-8">
    <title>INVOICE ERESEP TELEMEDICINE</title>
...
<body>
        ...
        <div class="card-body">
            ...
            <div class="row pt-5" style="padding-top:1rem;">
                <table class="table">
                    <thead>
                        <tr>
                            <th class="text-center" style="width: 200px;">LAYANAN</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($resepDetail as $ly)
                        <tr>
                            <td>{{$ly->nama_obat}}</td>
                            <td class="text-center">{{$ly->qty}}</td>
                            <td class="text-center">{{rupiah($ly->harga)}},00</td>
                            <td class="text-center">{{rupiah($ly->harga*$ly->qty)}},00</td>
                        </tr>
                        @endforeach
                        @endif
                        @isset($resep->diantar)
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{rupiah($payment->ongkos_kirim)}},00</td>
                                <td class="text-center">{{rupiah($payment->ongkos_kirim)}},00</td>
                            </tr>
                            @endif
                        @endisset
                    ...
                    <tfoot >
                        <tr >
                            ...
                            <th colspan="1" class="text-center" style="padding-top: 40px;">{{rupiah($subtotal)}},00</th>
                        </tr>
                    </tfoot>
                </table>
    ...
    <script type="text/javascript">
        function download() {
            window.open(
                "{{route('invoiceDownload', ['id'=>$permintaan->id_permintaan_telemedicine,'jenis'=>'eresep_telemedicine'])}}",
                "_blank"
            );
        }
    </script>
