            ...
            <div class="col-md-10">
                ...
                <div class="panel panel-default plain" id="dash_0">
                    ...
                    <div class="panel-body p30">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="invoice-logo"><img width="70" src="http://localhost/develop/mcu-wahidin/public/assets/images/logo-rsu.png" alt="Invoice logo"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="invoice-from">
                                    <ul class="list-unstyled text-right">
                                        <li style="color: #5EB63E;">INVOICE</li>
                                        <li>INV/20230605/HOMECARE/2435162676</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="invoice-details mt25">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2"></div>
                                        <div class="col-lg-4">
                                            <span>STEFANUS SIMANDJUNTAK</span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-8"></div>
                                        <div class="col-lg-4">
                                            <span>Tanggal Transaksi :<br>05 September 2023</span>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="per5 text-center">JMLAH</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>MCU - PAKET TULIP</td>
                                                    <td class="text-center">1</td>
                                                    <td class="text-center">Rp. 760.000</td>
                                                    <td class="text-center">Rp. 760.000</td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th class="text-center">Rp. 760.000</th>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                                ...
                                <div class="invoice-info">
                                    <ul class="list-unstyled">
                                        <li>Invoice ini sah dan diproses oleh komputer <br> Silakan hubungi RSUD WAHIDIN SUDIRO HUSODO apabila kamu membutuhkan bantuan. <br><br> Terakhir diupdate: 10 September 2022 14:25 WIB</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
