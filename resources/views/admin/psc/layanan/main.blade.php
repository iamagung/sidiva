...
<div class="page-content">
    ...
    <div class="card main-layer">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3">
                    <button type="button" class="btn btn-sm" style="background: #4E5FBC; color: #ffffff;" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bx bxs-plus-square"></i> Tambah Layanan</button>
                </div>
...
<script type="text/javascript">
    ...
    function formAdd(id='') {
        $.post("{{route('formAddPsc')}}",{id:id},function(data){
    ...
    function hapus(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.post("{{route('deleteLayananPc')}}",{id:id})
                .done((data) => {
                    if(data.status == "success"){
                        Swal.fire('Berhasil!', 'Berhasil Menghapus Data', 'success');
                        location.reload();
