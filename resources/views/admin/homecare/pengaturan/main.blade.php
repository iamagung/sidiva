									...
									<div class="accordion-body">
										<div class="row">
                                            <div class="col-md-12">
                                                <div class="row mb-3">
                                                    <div class="col-md-4">
                                                        <label for="">Jarak Maksimal Pelayanan (KM)</label>
									...
									<div class="accordion-body">
										<div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label for="">Perhitungan (Per- 1 KM)</label>
							...
							<div class="accordion-item">
								<h2 class="accordion-header" id="headingFour">
									<button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour"
										...
										INFORMASI PEMBATALAN HOME CARE
									</button>
								</h2>
									...
									<div class="accordion-body">
										<div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <textarea name="deskripsi" id="editor1" cols="90" rows="10" placeholder="Deskripsi" class="form-control" autocomplete="off"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
