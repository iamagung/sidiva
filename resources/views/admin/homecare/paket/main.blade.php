...
<script type="text/javascript">
    ...
    function hapus(id) {
        Swal.fire({
            ...
            text: "Data Paket MCU Akan Dihapus Permanen",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                $.post("{{route('deletePaketHC')}}",{id:id})
                .done((data) => {
                    if(data.status == "success"){
