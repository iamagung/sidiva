	...
	<div class="page-content">
		...
		<div class="card main-layer">
			...
			<div class="card-footer">
				<div class="col-md-12">
					<button type="button" class="btn mb-2" style="width: 100%; background: #3EC396; color: #fff;"
						id="simpan">SIMPAN</button>
				</div>
				<div class="col-md-12">
					<button type="button" class="btn mb-2" style="width: 100%; background: #5A6268; color: #fff;"
