                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <select name="layanan_id" id="layanan_id" class="form-control select2">
                            ...
                            <option @if(!empty($tenaga_medis->layanan_id) && $l->id_layanan_telemedicine == $tenaga_medis->layanan_id) selected @endif value="{{$l->id_layanan_telemedicine}}">{{$l->nama_layanan}}</option>
                            @endforeach
                            @endif
                        </select>
                    </div>
